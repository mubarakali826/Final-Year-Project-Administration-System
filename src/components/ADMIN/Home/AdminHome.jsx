  ...
  return (
    <div className="h-screen flex items-center">
      <div className="adminHome gap-4 h-[85%] w-[69%] ml-[26%] rounded-2xl p-8 flex flex-col">
        <div className="number-stats flex gap-4 h-[30%]">
          <div
          ...
          >
            <FaCircleArrowLeft
              ...
              size={20}
            />
            <h1 className="text-white font-bold card-name">Completed Projects</h1>
            <div className="bottom-div flex items-center absolute bottom-3 gap-10">
          ...
          >
            <FaCircleArrowLeft
              ...
              size={20}
            />
            <h1 className="text-white card-name font-bold">Unassigned Students</h1>
            <div className="bottom-div flex items-center absolute bottom-3 gap-10">
          ...
          >
            <FaCircleArrowLeft
              ...
              size={20}
            />
            <h1 className="text-white font-bold card-name">In-House Projects</h1>
            <div className="bottom-div flex items-center absolute bottom-3 gap-10">
        ...
        <div className="home-bottom flex rounded-lg ">
          <div className="w-[49%] pi rounded-lg">
            <PiChart  />
          </div>
