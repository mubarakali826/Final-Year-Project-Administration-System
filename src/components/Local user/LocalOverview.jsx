...
const LocalOverview = () => {
  return (
    <div className="local-overview-container flex h-screen w-screen ">
      <div className="beyond w-[50%] h-full relative">
        <div className="project-details w-full absolute top-[4rem] left-[4rem]">
          <div
            className="display-image-container h-[50%] bg-red-300"
            style={{
          ...
          <div className="tabs p-4">
            <Tabs defaultValue="account" className="w-[90%] m-auto">
              <TabsList className="bg-blue-200 text-gray-600">
